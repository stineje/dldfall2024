...
expressed in terms of right rotations (ror) and right shifts (>>) of
...
\begin{table}
  ...
  \begin{tabular}{|c|c|c|c|c|c|c|} \hline
    SHA-2 Algorithm & Variable & SHA-256 & SHA-512 \\ \hline
    Message Digest Size (bits)	& d & 256 & 512 \\ \hline
    Block Size (bits) & m & 512	& 1024 \\ \hline
    Word Size (bits) & w & 32 & 64 \\ \hline
    Rounds & r & 64 & 80 \\ \hline
    $\Sigma_0^{d} (x)$ & &
    $(x~ror~2) \oplus (x~ror~13) \oplus (x~ror~22)$ &
    $(x~ror~28) \oplus (x~ror~34) \oplus (x~ror~39)$ \\ \hline
    $\Sigma_1^{d} (x)$ & &
    $(x~ror~6) \oplus (x~ror~11) \oplus (x~ror~25)$ &
    $(x~ror~14) \oplus (x~ror~18) \oplus (x~ror~41)$ \\ \hline
    $\sigma_0^{d} (x)$ & &
    $(x~ror~7) \oplus (x~ror~18) \oplus (x >>3)$ &
    $(x~ror~1) \oplus (x~ror~8) \oplus (x >>7)$ \\ \hline
    $\sigma_1^{d} (x)$ & &
    $(x~ror~17) \oplus (x~ror~19) \oplus (x >>10)$ &
    $(x~ror~19) \oplus (x~ror~61) \oplus (x >>6)$ \\ \hline
  \end{tabular}
  }
